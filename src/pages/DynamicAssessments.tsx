...
import DynamicAssessmentCard from '@/components/DynamicAssessmentCard';
...
const DynamicAssessments = () => {
  ...
  const groupedAssessments = categories.reduce((acc, category) => {
    ...
    <div className="min-h-screen bg-blue-50">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl">
                    ...
                    <div className="space-y-3">
                      {categoryAssessments.slice(0, Math.ceil(categoryAssessments.length / 2)).map((assessment, index) => (
                        <DynamicAssessmentCard key={assessment.id} assessment={assessment} />
                      ))}
                    </div>
      ...
      <div className="px-4 py-16">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-foreground">How Our Dynamic Assessments Work</h2>
...
export default DynamicAssessments;

        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl font-bold text-heading mb-4">
              Privacy Policy and Legal Guide for factorbeam.com
            </h1>
          ...
          <div className="prose prose-lg max-w-none mb-12">
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-soft mb-4">When you register for an account, fill out an assessment, complete a form, or contact us, you may provide us with the following personal information:</p>
              ...
              <p className="text-foreground-soft mb-4">When you visit our website, we automatically collect certain information from your device, including:</p>
              <ul className="list-disc pl-6 space-y-2 text-foreground-soft">
              ...
              <p className="text-foreground-soft mt-4">
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-50 p-6 rounded-lg">
                ...
                <p className="text-foreground-soft mb-2"><strong>Toll-free number:</strong> 1-800-FACTORB (Required under CPRA for consumer requests)</p>
                <p className="text-foreground-soft"><strong>Mailing Address:</strong> FactorBeam Inc., 123 Privacy Street, San Francisco, CA 94105</p>
              </div>
            </section>
          </div>
          ...
          <div className="prose prose-lg max-w-none mb-12">
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-soft mb-4">Every business must have a clear procedure for handling requests from users to exercise their privacy rights.</p>
              ...
              <p className="text-foreground-soft mb-4">In the event of a personal data breach, prompt and transparent action is required.</p>
              <ol className="list-decimal pl-6 space-y-2 text-foreground-soft mb-6">

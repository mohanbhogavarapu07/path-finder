        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12 bg-blue-50 p-8 rounded-lg border-l-4 border-blue-400">
              ...
              <p className="text-foreground-soft mb-4 font-semibold">
            ...
            <section className="mb-12">
              ...
              <p className="text-foreground-soft mb-4">You are expressly prohibited from engaging in the following activities:</p>
